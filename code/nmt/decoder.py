...
class Decoder(nn.Module):
    ...
    def __init__(self, vocab_size, context_projection=None):
        ...
        self.context_size = config.hidden_size_encoder * (2 if config.bidirectional_encoder else 1)
        ...
        # Attenton
        self.input_lstm_size = config.embed_size + self.context_size
        ...
        self.init_context = torch.autograd.Variable(
            torch.Tensor(np.zeros(self.context_size))).cuda()
